...
ALLOWED_HOSTS = [
     "127.0.0.1",
    "localhost",
    "chorifans.pythonanywhere.com",
]

CSRF_TRUSTED_ORIGINS = [
    "https://chorifans.pythonanywhere.com",
]
...
# (nuestro /static de proyecto, donde está css/style.css, img/, etc.)
STATICFILES_DIRS = [
    BASE_DIR / "static",
]

# Opcionalmente, para cuando se haga deploy (no afecta en desarrollo)
